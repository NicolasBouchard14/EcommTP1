class Client < ApplicationRecord
  ...
  has_many :client_has_conjoints, :dependent => :destroy
  has_many :conjoints, :through => :client_has_conjoints, :dependent => :destroy
  ...
  accepts_nested_attributes_for :client_has_conjoints, :allow_destroy => true
  accepts_nested_attributes_for :conjoints, :allow_destroy => true
